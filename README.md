...
This will deploy your MCP server to a URL like: `mcp.<your-account>.workers.dev/mcp`
...
2. Enter your deployed MCP server URL (`mcp.<your-account>.workers.dev/mcp`)
...
```json
{
	"mcpServers": {
		"calculator": {
			...
			"args": [
				"mcp-remote",
				"http://localhost:8787/mcp" // or mcp.your-account.workers.dev/mcp
			]
		}
	}
}
